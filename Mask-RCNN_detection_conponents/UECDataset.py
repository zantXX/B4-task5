...
class UECFoodNewPixDataset(object):
    def __init__(self, split, transforms):
        ...
        self.newbbroot = "/export/space0/okamoto-ka/dataset/uecfood100BB/{}/".format(split)

        self.transforms = transforms
        #self.picklepath = "./file_number_BB_{}.pickle".format(split)
        self.picklepath = "./file_number_BB100_{}.pickle".format(split)
...
for i,d in enumerate(dataset):
    ...
    label = target['labels']
    #masks = target['masks']
    if (102 in label) or (101 in label):
        print(label)
