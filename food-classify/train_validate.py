...
def train_val_model(model, criterion, optimizer, scheduler, num_epochs=15):
    ...
    for epoch in range(num_epochs):
        ...
        logging.info('Learning rate {}'.format(scheduler.get_last_lr()))
        ...
        for phase in ['train', 'val']:  # each epoch does train and validate
            ...
            if phase == 'val' and epoch_accuracy > best_accuracy:
                ...
                best_model_weights = copy.deepcopy(model.state_dict())
                torch.save(best_model_weights, join(args.trained_models_folder, 'checkpoint_FOOD2101.pth'))
...
display_losses(train_losses, val_losses, 'Train-Val Loss 101')
