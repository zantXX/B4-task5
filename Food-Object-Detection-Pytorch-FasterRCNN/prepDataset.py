    ...
    for folder, _, files in tqdm(os.walk(root), desc='Copying files'):
        ...
        for file in files:
            ...
            if file.endswith('.jpg'):
                ...
                if not os.path.exists(os.path.join(img_path, file)):
                    if not os.path.islink(os.path.join(img_path, file)):
                        os.symlink( os.path.realpath(path_file), os.path.realpath(os.path.join(img_path, file)))
