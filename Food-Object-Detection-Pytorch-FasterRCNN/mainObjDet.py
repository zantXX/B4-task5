...
def main():
    ...
    model = torch.load("../UECFOOD100merged/model.pth")
    ...
    for epoch in range(num_epochs):
        ...
        lr_scheduler.step()
        # save model
        torch.save(model, os.path.join('../UECFOOD100merged/', 'model_1.pth'))
...
model = torch.load("../UECFOOD100merged/model_1.pth")
...
"""
img.save('../UECFOOD100merged/result_5.jpg')
